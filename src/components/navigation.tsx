...
const IconSimpleDollar = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
...
const IconNewspaper = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
...
const navItems = [
  ...
  { href: "/pages/news", label: "News", icon: IconNewspaper },
