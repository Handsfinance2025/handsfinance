// Filename: app/api/analyze-image/route.ts
// Important: Ensure you have @google/generative-ai installed: npm install @google/generative-ai
...
export async function POST(req: Request) {
  console.log("Backend API route /api/analyze-image hit");
